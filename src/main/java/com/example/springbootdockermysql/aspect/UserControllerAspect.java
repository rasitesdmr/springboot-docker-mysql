package com.example.springbootdockermysql.aspect;
...
public class UserControllerAspect {
    ...
    @Around("execution(* com.example.springbootdockermysql.controller.UserController.findAllUsers(..))")
    ...
    @Around("execution(* com.example.springbootdockermysql.controller.UserController.getByUserId(..))")
    ...
    @Around("execution(* com.example.springbootdockermysql.controller.UserController.createUser(..))")
    ...
    @Around("execution(* com.example.springbootdockermysql.controller.UserController.updateUser(..))")
    ...
    @Around("execution(* com.example.springbootdockermysql.controller.UserController.deleteUser(..))")
